...
include(joinpath(pwd(),"data","uc_3_24.jl")) # G_preprocess_dir
...
MOI.add_constraint(o, sum(1. * cgtf[g,t] for g in 1:Gs, t in 1:Ts) - fuel_cost, MOI.LessThan(0.))
...
if status != MOI.OPTIMAL
    ...
    cgtf_ = MOI.get.(o,MOI.VariablePrimal(),cgtf)

    fuel_cost_table = cgtf_ # already available, do not need convert
