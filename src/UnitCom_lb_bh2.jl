...
# Title: lower bound calculation through \bar{h}_2 single-side 
# Test result: successful
# A note: 
# the 1st stage trial point is generated by the surrogate of SP-lowerbound, 
# we found that the result doesn't change too much if we generate 1st stage trial point via the surrogate of \bar{h}_2
...
# test result
# [ Info: ▶ ite = 1, lb(SP_LB) = -29545.423 vs 16397.081 = lb(MSDRO_UB)
# [ Info: ▶ ite = 6, lb(SP_LB) = 16397.081 vs 25005.305 = lb(MSDRO_UB)
# [ Info: ▶ ite = 7, lb(SP_LB) = 25005.305 vs 26626.948 = lb(MSDRO_UB)
# [ Info: ▶ ite = 8, lb(SP_LB) = 26626.948 vs 28755.62 = lb(MSDRO_UB)
# [ Info: ▶ ite = 9, lb(SP_LB) = 28755.62 vs 30031.958 = lb(MSDRO_UB)
# [ Info: ▶ ite = 10, lb(SP_LB) = 30031.958 vs 31342.986 = lb(MSDRO_UB)
# [ Info: ▶ ite = 11, lb(SP_LB) = 31342.986 vs 32161.207 = lb(MSDRO_UB)
# [ Info: ▶ ite = 12, lb(SP_LB) = 32161.207 vs 32409.462 = lb(MSDRO_UB)
# [ Info: ▶ ite = 13, lb(SP_LB) = 32409.462 vs 32509.601 = lb(MSDRO_UB)
# [ Info: ▶ ite = 14, lb(SP_LB) = 32509.601 vs 32629.037 = lb(MSDRO_UB)
# [ Info: ▶ ite = 15, lb(SP_LB) = 32629.037 vs 32670.054 = lb(MSDRO_UB)
# [ Info: ▶ ite = 16, lb(SP_LB) = 32670.054 vs 32681.05 = lb(MSDRO_UB)
# [ Info: ▶ ite = 17, lb(SP_LB) = 32681.05 vs 32685.43 = lb(MSDRO_UB)
# [ Info: ▶ ite = 18, lb(SP_LB) = 32685.43 vs 32686.642 = lb(MSDRO_UB)
# [ Info: ▶ ite = 19, lb(SP_LB) = 32686.642 vs 32688.407 = lb(MSDRO_UB)
# [ Info: ▶ ite = 20, lb(SP_LB) = 32688.407 vs 32689.518 = lb(MSDRO_UB)
# [ Info: ▶ ite = 21, lb(SP_LB) = 32689.518 vs 32690.949 = lb(MSDRO_UB)
# [ Info: ▶ ite = 22, lb(SP_LB) = 32690.949 vs 32691.244 = lb(MSDRO_UB)
# [ Info: ▶ ite = 23, lb(SP_LB) = 32691.244 vs 32719.037 = lb(MSDRO_UB)
# [ Info: ▶ ite = 24, lb(SP_LB) = 32719.037 vs 32725.214 = lb(MSDRO_UB)
# [ Info: ▶ ite = 25, lb(SP_LB) = 32725.214 vs 32735.898 = lb(MSDRO_UB)
# [ Info: ▶ ite = 26, lb(SP_LB) = 32735.898 vs 32747.563 = lb(MSDRO_UB)
# [ Info: ▶ ite = 27, lb(SP_LB) = 32747.563 vs 32747.924 = lb(MSDRO_UB)
# [ Info: ▶ ite = 28, lb(SP_LB) = 32747.924 vs 32748.001 = lb(MSDRO_UB)
# [ Info: ▶ ite = 29, lb(SP_LB) = 32748.001 vs 32926.195 = lb(MSDRO_UB)
# [ Info: ▶ ite = 30, lb(SP_LB) = 32926.195 vs 32927.137 = lb(MSDRO_UB)
# [ Info: ▶ ite = 31, lb(SP_LB) = 32927.137 vs 32927.141 = lb(MSDRO_UB)
# [ Info: ▶ ite = 32, lb(SP_LB) = 32927.141 vs 32927.532 = lb(MSDRO_UB)
# [ Info: ▶ ite = 33, lb(SP_LB) = 32927.532 vs 32927.532 = lb(MSDRO_UB)
# [ Info: stop the main loop due to stagnation, the best lb = 32927.532
